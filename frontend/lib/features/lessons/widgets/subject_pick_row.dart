...
class SubjectPickRow extends StatefulWidget
{
  ...
  // Empty when there is nothing to say; the name is then centred.
  final String subtitle;

  final bool selected;

  // False for single-discipline subjects: there is nothing to open.
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          // Fixed height so ticking never reflows the list.
          height: widget.leading == null ? rowHeight : rowHeightWithAvatar,
          decoration: BoxDecoration(
            // Transparent of this colour, not Colors.transparent (black at zero
            // opacity), so the fade never passes through grey.
...
class SubjectDisciplinesDialog extends StatefulWidget
{
  ...
  // Never called with an empty set.
