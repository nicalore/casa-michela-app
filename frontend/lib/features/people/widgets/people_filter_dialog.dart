...
class _PeopleFilterDialogState extends State<PeopleFilterDialog> 
{
  ...
  void _toggleRole(String role, bool isSelected) 
  {
    setState(() 
    {
      ...
      _currentState = _currentState.copyWith(selectedRoles: updatedRoles, clearRoles: updatedRoles.isEmpty);
    });
  }
  ...
  void _removeSubject(String subject) 
  {
    setState(() 
    {
      ...
      _currentState = _currentState.copyWith(taughtSubjects: updated, clearTaughtSubjects: updated.isEmpty);
    });
  }
  ...
  Widget _buildTextField(TextEditingController controller, String hint, ValueChanged<String> onChanged, {ValueChanged<String>? onSubmitted}) 
  {
    return Container(
      height:     50,
  ...
  Widget build(BuildContext context) 
  {
    ...
    final bool isFullAgeRange     = _currentState.ageRange == null || (_currentState.ageRange!.start == 5 && _currentState.ageRange!.end == 99);
    final bool isFullSubjectRange = _currentState.taughtSubjectsCount == null || (_currentState.taughtSubjectsCount!.start == 1 && _currentState.taughtSubjectsCount!.end == 15);
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _AutocompleteField(
                          ...
                          onChanged:  (val) => setState(() => _currentState = _currentState.copyWith(city: val, clearCity: val.isEmpty)),
                        ),
                        ...
                        SliderTheme(
                          data: SliderTheme.of(context).copyWith(
                            ...
                            valueIndicatorTextStyle: GoogleFonts.plusJakartaSans(color: Colors.white, fontWeight: FontWeight.w600),
                          ),
                          child: RangeSlider(
                            ...
                            labels: RangeLabels(
                              ...
                              _currentState.ageRange?.end.round() == 99 ? '99+' : _currentState.ageRange?.end.round().toString() ?? '99+',
                            ),
                            onChanged: (RangeValues values) 
                            {
                              setState(() => _currentState = _currentState.copyWith(ageRange: values));
                            },
                          ),
                        ),
                        Center(
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    _DialogDropdownMenu<String?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(childrenCount: val, clearChildrenCount: val == null)),
                                    ),
                                  ],
                                )
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    _DialogDropdownMenu<bool?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(isActiveCollaborator: val, clearCollaborator: val == null)),
                                    ),
                                    ...
                                    _DialogDropdownMenu<String?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(enrollmentYear: val, clearEnrollment: val == null)),
                                    ),
                                  ],
                                )
                              : const SizedBox(width: double.infinity),
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    _DialogDropdownMenu<String?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(educationLevel: val, clearEducationLevel: val == null)),
                                    ),
                                    ...
                                    _AutocompleteField(
                                      ...
                                      onChanged:  (val) => setState(() => _currentState = _currentState.copyWith(schoolName: val, clearSchoolName: val.isEmpty)),
                                    ),
                                    ...
                                    _DialogDropdownMenu<String?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(schoolClass: val, clearSchoolClass: val == null)),
                                    ),
                                    ...
                                    _AutocompleteField(
                                      ...
                                      onChanged:  (val) => setState(() => _currentState = _currentState.copyWith(studyProgram: val, clearStudyProgram: val.isEmpty)),
                                    ),
                                    ...
                                    _DialogDropdownMenu<bool?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(earlyExit: val, clearEarlyExit: val == null)),
                                    ),
                                  ],
                                )
                              : const SizedBox(width: double.infinity),
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    _DialogDropdownMenu<String?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(collaborationType: val, clearCollaborationType: val == null)),
                                    ),
                                  ],
                                )
                              : const SizedBox(width: double.infinity),
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    _AutocompleteField(
                                      ...
                                      hint:        'Scrivi materia e premi Invio',
                                    ...
                                    SliderTheme(
                                      ...
                                      child: RangeSlider(
                                        ...
                                        labels: RangeLabels(
                                          ...
                                          _currentState.taughtSubjectsCount?.end.round() == 15 ? '15+' : _currentState.taughtSubjectsCount?.end.round().toString() ?? '15+',
                                        ),
                                        onChanged: (RangeValues values) 
                                        {
                                          setState(() => _currentState = _currentState.copyWith(taughtSubjectsCount: values));
                                        },
                                      ),
                                    ),
                                    Center(
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    _buildTextField(
                                      ...
                                      'Es. Yoga',
                                      (val) => setState(() => _currentState = _currentState.copyWith(courseType: val, clearCourseType: val.isEmpty)),
                                    ),
                                    ...
                                    _DialogDropdownMenu<bool?>(
                                      ...
                                      onChanged: (val) => setState(() => _currentState = _currentState.copyWith(isMedicalCertificateValid: val, clearMedicalCert: val == null)),
                                    ),
                                  ],
                                )
                              : const SizedBox(width: double.infinity),
  ...
  Widget build(BuildContext context) 
  {
    return RawAutocomplete<String>(
      ...
      optionsBuilder: (TextEditingValue textEditingValue) 
      {
        ...
        return widget.options.where((String option) => option.toLowerCase().contains(textEditingValue.text.toLowerCase()));
      },
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(100), 
            border:       Border.all(color: widget.isSelected ? const Color(0xFF003C82) : const Color(0xFFE0E5EC), width: 1.0)
          ), 
