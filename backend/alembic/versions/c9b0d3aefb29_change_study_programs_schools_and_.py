...
def upgrade() -> None:
    ...
    # 0. SVUOTAMENTO DATI (Risolve l'errore NotNullViolationError)
    # Rimuove i dati fittizi dalle tabelle in fase di alterazione in modo che le nuove colonne NOT NULL non vadano in crash
    ...
    # 2. ELIMINAZIONE VINCOLI ESTERNI (Dipendenze verso vecchie tabelle)
    ...
    # 5. MODIFICA TABELLE ESISTENTI (school_enrollments)
    ...
    # 6. MODIFICA TABELLE ESISTENTI (study_programs - Enum fix applicato qui)
    ...
    # 7. MODIFICA TABELLE ESISTENTI (teaching_competences)
