...
class ParentalResponsibility(Base):
    ...
    __table_args__ = (
        ...
        *not_blank_when_present_constraints("pickup_restriction_reason"),
        *no_surrounding_whitespace_constraints("pickup_restriction_reason"),
    )
    ...
    parent: Mapped[Parent] = relationship(back_populates="children_relationships")

    child: Mapped[Person] = relationship(back_populates="parental_relationships")